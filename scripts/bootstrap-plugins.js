...
(function(window, document, undefined) {
    ...
    var defaults = {
        messages: {
            ...
            matches: '%s tidak sama dengan %s.',
            "default": '%s masih default, tolong ubah.',
            valid_email: '%s harus berisi alamat email yang valid.',
            valid_emails: '%s harus berisi semua alamat email yang valid.',
            min_length: '%s minimal %s karakter.',
            max_length: '%s maksimal %s karakter.',
            exact_length: '%s harus %s karakter.',
            greater_than: '%s harus berisi angka yang lebih besar dari %s.',
            less_than: '%s harus berisi angka yang lebih kecil dari %s.',
            alpha: '%s harus berisi karakter abjad.',
            alpha_space: '%s harus berisi karakter abjad dan spasi.',
            alpha_numeric: '%s harus berisi karakter abjad dan angka.',
            alpha_low_up_numeric: '%s harus berisi angka, huruf kecil dan huruf besar.',
            alpha_dash: '%s harus berisi karakter abjad, angka, underscore, dan dash.',
            numeric: '%s harus berisi angka.',
            integer: '%s harus berisi bilangan bulat.',
            decimal: '%s harus berisi angka desimal.',
            is_natural: '%s harus berisi angka positif.',
            is_natural_no_zero: '%s harus berisi angka lebih besar dari nol.',
            valid_ip: '%s harus berisi IP yang valid.',
            valid_base64: '%s harus berisi string base64.',
            valid_credit_card: '%s harus berisi nomor kartu kredit yang valid.',
            is_file_type: '%s harus berisi %s berkas.',
            valid_url: '%s harus berisi URL yang valid.',
            greater_than_date: '%s harus berisi tanggal lebih dari %s.',
            less_than_date: '%s harus berisi tanggal kurang dari %s.',
            greater_than_or_equal_date: '%s harus berisi tanggal lebih dari atau setidaknya sama dengan %s',
            less_than_or_equal_date: '%s harus berisi tanggal kurang dari atau setidaknya sama dengan %s.'
        },
    ...
    var ruleRegex = /^(.+?)\[(.+)\]$/,
        ...
        emailRegexW3 = /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/,
    ...
    return function () {
        ...
        this.init = function(ele) {
            ...
            $(ele.container)
                ...
                .append('<input type="range" value="'+ele.zoom.min+'" min="'+ele.zoom.min+'" max="'+ele.zoom.max+'" step="'+ele.zoom.steps+'"><div class="crop-main"></div>');
        ...
        this.import = function() {
            ...
            $('body').append('<input type="file" id="choose-img" style="display:none">');
